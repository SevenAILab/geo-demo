...
const lazyGeo = createLazyView(() => import("./views/geo.ts"), notifyLazyViewChanged);
...
type EmbeddedChatRenderContext = {
  chatAvatarUrl: string | null;
  effectiveAssistantAvatar: string | null;
  showThinking: boolean;
  showToolCalls: boolean;
  chatDisabledReason: string | null;
  chatViewError: string | null;
  chatAgentId: string;
  resolvedAgentId: string | null;
  chatWorkspaceFiles: ChatWorkspaceFilesState;
  refreshChatWorkspaceFiles: () => void;
  openChatWorkspaceFile: (name: string) => void;
...
function renderEmbeddedChat(state: AppViewState, ctx: EmbeddedChatRenderContext) {
  return renderChat({
    ...
    showToolCalls: ctx.showToolCalls,
    loading: state.chatLoading,
    sending: state.chatSending,
    compactionStatus: state.compactionStatus,
    fallbackStatus: state.fallbackStatus,
    assistantAvatarUrl: ctx.chatAvatarUrl,
    ...
    onRequestUpdate: ctx.requestHostUpdate,
    ...
    assistantAvatar: ctx.effectiveAssistantAvatar,
...
export function renderApp(state: AppViewState) {
  ...
  const embeddedChatContext: EmbeddedChatRenderContext = {
    chatAvatarUrl,
  ...
  return html`
    ...
    <div
      class="shell ${isChat ? "shell--chat" : ""} ${isGeo ? "shell--geo" : ""} ${navCollapsed
        ? "shell--nav-collapsed"
