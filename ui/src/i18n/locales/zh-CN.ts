...
export const zh_CN: TranslationMap = {
  ...
  geo: {
    ...
    analysis: {
      ...
      alertBody:
        "Due to a lack of authoritative structured data, your primary citation probability in mainstream large language models (LLMs) is below the industry benchmark.",
      viewReason: "View Reason",
      previewTitle: "Website Preview: {url}",
      previewFallback:
        "This site does not allow embedded previews. A reference layout has been displayed.",
      initialPrompt:
        'Please perform a GEO analysis on {url}: AI visibility, Schema/entity recognition, content citability, and provide actionable optimization recommendations.\n\nAfter the analysis, output only one JSON code block (```json) at the end of the reply, strictly following the schema below. Do not output any other JSON:\n{\n  "totalScore": integer 0-100,\n  "rating": "weak" | "moderate" | "strong",\n  "summary": "one-sentence summary",\n  "metrics": [\n    { "id": "schema", "label": "Schema.org", "value": 0-100, "statusLabel": "status description" },\n    { "id": "entity", "label": "Entity Connectivity", "value": 0-100, "statusLabel": "status description" },\n    { "id": "aiResponse", "label": "AI Response", "value": 0-100, "statusLabel": "status description" }\n  ],\n  "gaps": [\n    { "id": "unique id", "title": "gap title", "impact": "high" | "medium" | "low", "description": "gap description" }\n  ]\n}',
    },
    skills: {
      loading: "AI is analyzing…",
      errorTitle: "Unable to generate results",
      errorBody:
        "The Agent did not return valid JSON. Please check the Gateway conversation or try again.",
      retry: "Retry",
      assessmentPrompt:
  ...
  workboard: {
    ...
    detailNotePlaceholder: "添加决策、阻塞项或证明备注……",
    detailAddNote: "添加备注",
    openSession: "打开会话",
    ...
    start: "开始",
    dependencies: "依赖项",
    dependenciesReady: "{count} 就绪",
    dependenciesReadyTitle: "{count} 个依赖项已完成。",
    dependenciesBlocked: "{count} 阻塞",
  ...
  cron: {
    ...
    form: {
      ...
      noneInternal: "无（仅内部）",
      deliveryHelp: "发布将摘要���送到聊天。无保持执行仅内部。",
